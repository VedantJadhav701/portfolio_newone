...
const experiences = [
    {
        id: 1,
        role: "Co-Founder / AI System Architect",
        company: "Industrial AI Solutions (Energy Sector)",
        period: "2024 - Present",
        description: "Designing multi-agent system architectures for energy operations. Integrating deep research and engineering to build Drill Agents, Flow Agents, and operational decision support systems.",
    },
    {
        id: 2,
        ...
        description: "Engineered production LLM and RAG systems achieving 35% retrieval accuracy improvement. Architected Dockerized inference pipelines under constrained hardware environments (CUDA, PyTorch).",
    },
    {
        id: 3,
        role: "AI & ML Intern",
        ...
        description: "Delivered 5+ NLP applications using AWS Lambda and Streamlit. Automated text summarization and classification workflows, emphasizing production-grade ML infrastructure.",
    }
];
